...
if edad1 >= 18: print("Es mayor de edad")
...
if par % 2 == 0 : print("Ha ingresado un numero par")
...
if edad4 < 12 : print("Menor de 12 años.")
elif 12 <= edad4 < 18 : print("Mayor o igual que 12 años y menor que 18 años")
elif 18 <= edad4 < 30 : print("Mayor o igual que 18 años y menor que 30 años")
else : print("Mayor o igual a 30 años")
...
contraseña = input("Introducir una contraseña con con una longitud de 8 a 14 caracteres: ")

if len(contraseña) >= 8 and len(contraseña) <= 14 : print("Ha ingresado una contraseña correcta.")
...
if media > mediana and mediana > moda:
    ...
    print("Distribución irregular (no se ajusta a un sesgo típico)")
...
palabra = input("Por favor brinde una palabra o frase: ")
...
numero = input("Ingrese un numero segun la opcion que desee: \n1(Nombre en mayuscula) \n2(Nombre en minuscula) \n3(Nombre con la primer letra en mayuscula y el resto en minuscula) \nOpcion: ")

if numero == "1" : print(nombre.upper())
elif numero == "2" : print(nombre.lower())
...
magnitud = int(input("Ingrese una magnitud de un terremoto para classificarla: "))

if magnitud < 3 : print("Muy leve")
elif 3 <= magnitud <= 4 : print("Leve")
elif 4 <= magnitud <= 5 : print("Moderado")
elif 5 <= magnitud <= 6 : print("Fuerte")
elif 6 <= magnitud <= 7 : print("Muy fuerte")
else : print("Extremo")
...
mes = int(input("¿Qué mes del año es? (1 al 12): "))
dia = int(input("¿Qué día es? (1 al 31): "))
...
if hemisferio == "n":
    ...
    print("Hemisferio no reconocido. Debe ser 'N' o 'S'.")
